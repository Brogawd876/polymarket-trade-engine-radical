        ...
        <div className="p-8 max-w-6xl mx-auto space-y-8">
            <header className="flex justify-between items-start">
                <div>
                    ...
                    <p className="text-slate-400 mt-2 text-lg">Configure replay and simulated paper sessions</p>
                </div>
            ...
            {engineConfig && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="p-4 rounded-xl border flex flex-col justify-between bg-emerald-500/5 border-emerald-500/20">
                        <div className="flex items-center justify-between mb-2">
                             <div className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Exchange Submission</div>
            ...
            <section className="bg-slate-800/50 border border-amber-500/30 rounded-2xl p-6 shadow-xl flex items-start gap-4">
                <div className="p-3 bg-amber-500/10 rounded-xl">
                    <LockIcon className="w-6 h-6 text-amber-400" />
                </div>
                <div>
                    <h2 className="text-xl font-bold text-slate-100">Live Promotion Lane Unavailable</h2>
                    <p className="text-sm text-amber-200/70 mt-1">
                        Gate 0 is unpassed and live authorization is not implemented. This control plane has no live arming or submission endpoint.
                    </p>
                </div>
            </section>
